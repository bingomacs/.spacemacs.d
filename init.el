...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(writeroom-mode focus anki-editor)

   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()

   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(vi-tilde-fringe pyim)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-startup-banner '"~/.spacemacs.d/img/jump.png"
   ...
   dotspacemacs-themes '(spacemacs-dark doom-one solarized-dark material-light solarized-light atom-one-dark spacemacs-light)
   ...
   dotspacemacs-distinguish-gui-tab "C-i"
